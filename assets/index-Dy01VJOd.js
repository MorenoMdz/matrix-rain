...
`);for(let e=1;e<t.length;e++)if(t[e].indexOf(`debug.js`)===-1&&t[e].trim()!==`Error`)return t[e].trim()}return`Unknown source`}function Pl(e,t){if(wl){if(Ol||jl(),t===void 0)El.push({text:e,source:Nl()}),El.length>Dl&&El.shift(),kl=!0;else{let n=Tl.get(e);if(n){if(n.value===t)return;n.value=t}else Tl.set(e,{value:t,source:Nl()});kl=!0}!Al&&kl&&(Al=!0,requestAnimationFrame(Ml))}}function Fl(e){wl=e===void 0?!wl:!!e,Ol&&(Ol.style.visibility=wl?`visible`:`hidden`)}var Il,Ll;function Rl(e,t,n){Il||(Il=new Sa(t),e.add(Il)),!Ll&&n&&(Ll=new Ta(n,16711680),e.add(Ll))}function zl(e){Il&&=(e.remove(Il),Il.dispose(),null),Ll&&=(e.remove(Ll),Ll.dispose(),null)}function Bl(){Il&&Il.update(),Ll&&Ll.update()}var Vl=!1,Hl=0,Ul=0,Wl=!1;function Gl(e){Wl=e}var Kl=new K,$={w:!1,a:!1,s:!1,d:!1,space:!1,shift:!1},ql=new Set;function Jl(){$.w=ql.has(`w`)||ql.has(`arrowup`),$.a=ql.has(`a`)||ql.has(`arrowleft`),$.s=ql.has(`s`)||ql.has(`arrowdown`),$.d=ql.has(`d`)||ql.has(`arrowright`),$.space=ql.has(` `),$.shift=ql.has(`shift`)}var Yl=30,Xl=.002,Zl;function Ql(e,t){Zl=e;let n=new Rt(0,0,0,`YXZ`);n.setFromQuaternion(e.quaternion),Hl=n.x,Ul=n.y,t.addEventListener(`click`,e=>{if(e.target.closest(`a`)||e.target.closest(`button`)||e.target.closest(`.help-modal-content`))return;let n=document.getElementById(`help-modal`);n&&!n.classList.contains(`hidden`)||Vl||t.requestPointerLock()}),document.addEventListener(`pointerlockchange`,()=>{Vl=document.pointerLockElement===t}),document.addEventListener(`mousemove`,e=>{Vl&&eu(e.movementX||0,e.movementY||0)}),document.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();ql.add(t),Jl()}),document.addEventListener(`keyup`,e=>{let t=e.key.toLowerCase();ql.delete(t),Jl()}),window.addEventListener(`blur`,()=>{ql.clear(),Jl()})}function $l(e,t){if(!Vl&&!Wl)return;let n=Yl*Math.min(e/1e3,.1),r=Kl;r.set(0,0,0),$.w&&--r.z,$.s&&(r.z+=1),$.a&&--r.x,$.d&&(r.x+=1),$.space&&(r.y+=1),$.shift&&--r.y,r.lengthSq()>0&&(r.normalize(),t.translateX(r.x*n),t.translateY(r.y*n),t.translateZ(r.z*n))}function eu(e,t){if(!Zl)return;Ul-=e*Xl,Hl-=t*Xl;let n=Math.PI/2-.01;Hl=Math.max(-n,Math.min(n,Hl));let r=new Rt(Hl,Ul,0,`YXZ`);Zl.quaternion.setFromEuler(r)}function tu(){if(!(`ontouchstart`in window||navigator.maxTouchPoints>0))return;Gl(!0);let e=document.createElement(`div`);e.id=`joystick-base`;let t=document.createElement(`div`);t.id=`joystick-stick`,e.appendChild(t),document.body.appendChild(e);let n=document.createElement(`div`);n.id=`mobile-guide`,n.innerHTML=`
  ...
  `,document.body.appendChild(n),setTimeout(()=>{n.style.opacity=`0`,setTimeout(()=>n.remove(),1e3)},4e3);let r=null,i=null,a={x:0,y:0},o={x:0,y:0};document.addEventListener(`touchmove`,n=>{(n.target.tagName===`CANVAS`||n.target===e||n.target===t||n.target.closest(`#mobile-guide`))&&n.preventDefault()},{passive:!1}),document.addEventListener(`touchstart`,n=>{if(!(n.target.closest(`a`)||n.target.closest(`button`)||n.target.closest(`.help-modal-content`)))for(let s=0;s<n.changedTouches.length;s++){let c=n.changedTouches[s],l=c.clientX<window.innerWidth/2;l&&r===null?(r=c.identifier,a={x:c.clientX,y:c.clientY},e.style.display=`block`,e.style.left=`${a.x-50}px`,e.style.top=`${a.y-50}px`,t.style.transform=`translate(0px, 0px)`):!l&&i===null&&(i=c.identifier,o={x:c.clientX,y:c.clientY})}},{passive:!1}),document.addEventListener(`touchmove`,e=>{for(let n=0;n<e.changedTouches.length;n++){let s=e.changedTouches[n];if(s.identifier===r){let e=s.clientX-a.x,n=s.clientY-a.y,r=Math.min(Math.sqrt(e*e+n*n),50),i=Math.atan2(n,e),o=Math.cos(i)*r,c=Math.sin(i)*r;if(t.style.transform=`translate(${o}px, ${c}px)`,$.w=!1,$.s=!1,$.a=!1,$.d=!1,r>10){let e=r/50*Math.cos(i),t=r/50*Math.sin(i);e>.3&&($.d=!0),e<-.3&&($.a=!0),t>.3&&($.s=!0),t<-.3&&($.w=!0)}}else s.identifier===i&&(eu(s.clientX-o.x,s.clientY-o.y),o={x:s.clientX,y:s.clientY})}},{passive:!1});function s(t){t===r?(r=null,e.style.display=`none`,$.w=!1,$.a=!1,$.s=!1,$.d=!1):t===i&&(i=null)}document.addEventListener(`touchend`,e=>{for(let t=0;t<e.changedTouches.length;t++)s(e.changedTouches[t].identifier)}),document.addEventListener(`touchcancel`,e=>{for(let t=0;t<e.changedTouches.length;t++)s(e.changedTouches[t].identifier)})}var nu=new fn;nu.fog=new dn(0,150,250);var ru=new na(30,qc(),15,250);ru.position.z=60;var iu=new na(75,qc(),1,5e3);iu.position.set(0,80,120),iu.lookAt(0,0,0);var au=ru,ou=new Wc({antialias:!0});ou.setSize(window.innerWidth,window.innerHeight),ou.setPixelRatio(Math.min(window.devicePixelRatio,2)),document.body.appendChild(ou.domElement),Ql(ru,document.body),tu(),Sl();var{update:su,resize:cu,getMesh:lu}=ml(nu,ru),uu=5+Math.random()*15,du=[new URL(`/matrix-rain/assets/neo-BKRROx-L.png`,``+import.meta.url).href,new URL(`/matrix-rain/assets/morpheus-B8N9IyYi.png`,``+import.meta.url).href,new URL(`/matrix-rain/assets/smith-D5UTlMPw.png`,``+import.meta.url).href,new URL(`/matrix-rain/assets/smith2-BOWZY_9s.png`,``+import.meta.url).href,new URL(`/matrix-rain/assets/trinity-CtrjEhNL.jpg`,``+import.meta.url).href,new URL(`/matrix-rain/assets/matrix-EYXKv4oQ.jpg`,``+import.meta.url).href],fu=[],pu=performance.now(),mu=new Yr,hu=new Y,gu=[];function _u(){if(gu.length===0){gu=[...du];for(let e=gu.length-1;e>0;e--){let t=Math.floor(Math.random()*(e+1));[gu[e],gu[t]]=[gu[t],gu[e]]}}return gu.pop()}function vu(){if(fu.length>=3)return;let e=new K,t=!1,n=0;for(;!t&&n<10;){n++;let r=50+Math.random()*40,i=new K(0,0,-1);i.x+=(Math.random()-.5)*1.5,i.y+=(Math.random()-.5)*1,i.normalize(),i.applyQuaternion(ru.quaternion),e.copy(ru.position).add(i.multiplyScalar(r)),t=!0;for(let n of fu)if(e.distanceTo(n.mesh.position)<60){t=!1;break}}if(!t)return;let{update:r,mesh:i,dispose:a}=vl(nu,{imageSrc:_u(),density:2,colorProminence:.95,contrastBoost:!0,brightness:1.5,fadeInDuration:4});i.position.copy(e),i.lookAt(ru.position),nu.add(i),fu.push({update:r,mesh:i,dispose:a,spawnTime:performance.now()})}Jc(e=>{ru.aspect=e,ru.updateProjectionMatrix(),iu.aspect=e,iu.updateProjectionMatrix(),ou.setSize(window.innerWidth,window.innerHeight),cu(ru)});var yu=performance.now();function bu(e){requestAnimationFrame(bu);let t=e-yu;yu=e,Cl(e),$l(t,ru),ru.updateMatrixWorld(),ru.matrixWorldInverse.copy(ru.matrixWorld).invert(),su(t,ru),e-pu>uu*1e3&&(vu(),pu=e,uu=5+Math.random()*15),hu.multiplyMatrices(ru.projectionMatrix,ru.matrixWorldInverse),mu.setFromProjectionMatrix(hu);for(let n=fu.length-1;n>=0;n--){let r=fu[n];r.update(t);let i=r.mesh.children[0];i.updateMatrixWorld(),e-r.spawnTime>2e3&&(mu.intersectsObject(i)||(nu.remove(r.mesh),r.dispose(),fu.splice(n,1)))}au===iu&&iu.lookAt(ru.position),Bl(),Pl(`Frame Time`,t.toFixed(2)+` ms`),Pl(`Draw Calls`,ou.info.render.calls),Pl(`Triangles`,ou.info.render.triangles),performance.memory&&Pl(`Memory (MB)`,(performance.memory.usedJSHeapSize/1048576).toFixed(1)),ou.render(nu,au)}bu(performance.now());var xu=!1,Su=!1;function Cu(){document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(()=>{})}function wu(){Su=!Su;let e=document.querySelector(`.footer`),t=document.getElementById(`fps-counter`);Su?(e&&(e.style.visibility=`hidden`),Fl(!1),t&&(t.style.visibility=`hidden`)):(e&&(e.style.visibility=`visible`),Fl(xu),t&&(t.style.visibility=xu?`visible`:`hidden`))}window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if((t==="`"||t===`~`)&&!Su){xu=!xu,Fl(xu);let e=document.getElementById(`fps-counter`);e&&(e.style.visibility=xu?`visible`:`hidden`),au===iu||xu?Rl(nu,ru,lu()):zl(nu)}if(t===`g`&&!Su&&(au=au===ru?iu:ru,au===iu||xu?Rl(nu,ru,lu()):zl(nu)),t===`f`&&Cu(),t===`h`&&wu(),e.key===`Escape`){let e=document.getElementById(`help-modal`);e&&!e.classList.contains(`hidden`)&&e.classList.add(`hidden`)}});var Tu=0,Eu;window.addEventListener(`touchstart`,e=>{if(e.target.closest(`a`)||e.target.closest(`button`)||e.target.closest(`.help-modal-content`))return;let t=new Date().getTime(),n=t-Tu;n<300&&n>0?(Cu(),clearTimeout(Eu),e.preventDefault()):Eu=setTimeout(()=>{wu()},800),Tu=t}),window.addEventListener(`touchend`,()=>clearTimeout(Eu)),window.addEventListener(`touchmove`,()=>clearTimeout(Eu));var Du=`https://anshulsharma.org/posts/matrix-rain/`,Ou=document.getElementById(`devlog-link-footer`),ku=document.getElementById(`devlog-link-modal`);Ou&&!Ou.getAttribute(`href`)&&(Ou.href=Du),ku&&!ku.getAttribute(`href`)&&(ku.href=Du);var Au=document.getElementById(`help-modal`),ju=document.getElementById(`help-toggle`),Mu=document.getElementById(`help-modal-close`);ju&&Au&&ju.addEventListener(`click`,e=>{e.preventDefault(),Au.classList.toggle(`hidden`)}),Mu&&Au&&Mu.addEventListener(`click`,()=>{Au.classList.add(`hidden`)}),Au&&Au.addEventListener(`click`,e=>{e.target===Au&&Au.classList.add(`hidden`)});