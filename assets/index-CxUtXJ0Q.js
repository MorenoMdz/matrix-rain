...
`);for(let e=1;e<t.length;e++)if(t[e].indexOf(`debug.js`)===-1&&t[e].trim()!==`Error`)return t[e].trim()}return`Unknown source`}function Pl(e,t){if(wl){if(Ol||jl(),t===void 0)El.push({text:e,source:Nl()}),El.length>Dl&&El.shift(),kl=!0;else{let n=Tl.get(e);if(n){if(n.value===t)return;n.value=t}else Tl.set(e,{value:t,source:Nl()});kl=!0}!Al&&kl&&(Al=!0,requestAnimationFrame(Ml))}}function Fl(e){wl=e===void 0?!wl:!!e,Ol&&(Ol.style.visibility=wl?`visible`:`hidden`)}var Il,Ll;function Rl(e,t,n){Il||(Il=new Sa(t),e.add(Il)),!Ll&&n&&(Ll=new Ta(n,16711680),e.add(Ll))}function zl(e){Il&&=(e.remove(Il),Il.dispose(),null),Ll&&=(e.remove(Ll),Ll.dispose(),null)}function Bl(){Il&&Il.update(),Ll&&Ll.update()}var Vl=!1,Hl=0,Ul=0,Wl=!1;function Gl(e){Wl=e}var Kl=new K,$={w:!1,a:!1,s:!1,d:!1,space:!1,shift:!1},ql=new Set;function Jl(){$.w=ql.has(`w`)||ql.has(`arrowup`),$.a=ql.has(`a`)||ql.has(`arrowleft`),$.s=ql.has(`s`)||ql.has(`arrowdown`),$.d=ql.has(`d`)||ql.has(`arrowright`),$.space=ql.has(` `),$.shift=ql.has(`shift`)}var Yl=30,Xl=.002,Zl;function Ql(e,t){Zl=e;let n=new Rt(0,0,0,`YXZ`);n.setFromQuaternion(e.quaternion),Hl=n.x,Ul=n.y,t.addEventListener(`click`,e=>{if(e.target.closest(`a`)||e.target.closest(`button`)||e.target.closest(`.help-modal-content`))return;let n=document.getElementById(`help-modal`);n&&!n.classList.contains(`hidden`)||Vl||t.requestPointerLock()}),document.addEventListener(`pointerlockchange`,()=>{Vl=document.pointerLockElement===t}),document.addEventListener(`mousemove`,e=>{Vl&&eu(e.movementX||0,e.movementY||0)}),document.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();ql.add(t),Jl()}),document.addEventListener(`keyup`,e=>{let t=e.key.toLowerCase();ql.delete(t),Jl()}),window.addEventListener(`blur`,()=>{ql.clear(),Jl()})}function $l(e,t){if(!Vl&&!Wl)return;let n=Yl*Math.min(e/1e3,.1),r=Kl;r.set(0,0,0),$.w&&--r.z,$.s&&(r.z+=1),$.a&&--r.x,$.d&&(r.x+=1),$.space&&(r.y+=1),$.shift&&--r.y,r.lengthSq()>0&&(r.normalize(),t.translateX(r.x*n),t.translateY(r.y*n),t.translateZ(r.z*n))}function eu(e,t){if(!Zl)return;Ul-=e*Xl,Hl-=t*Xl;let n=Math.PI/2-.01;Hl=Math.max(-n,Math.min(n,Hl));let r=new Rt(Hl,Ul,0,`YXZ`);Zl.quaternion.setFromEuler(r)}function tu({showGuide:e=!0}={}){if(!(`ontouchstart`in window||navigator.maxTouchPoints>0))return;Gl(!0);let t=document.createElement(`div`);t.id=`joystick-base`;let n=document.createElement(`div`);if(n.id=`joystick-stick`,t.appendChild(n),document.body.appendChild(t),e){let e=document.createElement(`div`);e.id=`mobile-guide`,e.innerHTML=`
    ...
    `,document.body.appendChild(e),setTimeout(()=>{e.style.opacity=`0`,setTimeout(()=>e.remove(),1e3)},4e3)}let r=null,i=null,a={x:0,y:0},o={x:0,y:0};document.addEventListener(`touchmove`,e=>{(e.target.tagName===`CANVAS`||e.target===t||e.target===n||e.target.closest(`#mobile-guide`))&&e.preventDefault()},{passive:!1}),document.addEventListener(`touchstart`,e=>{if(!(e.target.closest(`a`)||e.target.closest(`button`)||e.target.closest(`.help-modal-content`)))for(let s=0;s<e.changedTouches.length;s++){let c=e.changedTouches[s],l=c.clientX<window.innerWidth/2;l&&r===null?(r=c.identifier,a={x:c.clientX,y:c.clientY},t.style.display=`block`,t.style.left=`${a.x-50}px`,t.style.top=`${a.y-50}px`,n.style.transform=`translate(0px, 0px)`):!l&&i===null&&(i=c.identifier,o={x:c.clientX,y:c.clientY})}},{passive:!1}),document.addEventListener(`touchmove`,e=>{for(let t=0;t<e.changedTouches.length;t++){let s=e.changedTouches[t];if(s.identifier===r){let e=s.clientX-a.x,t=s.clientY-a.y,r=Math.min(Math.sqrt(e*e+t*t),50),i=Math.atan2(t,e),o=Math.cos(i)*r,c=Math.sin(i)*r;if(n.style.transform=`translate(${o}px, ${c}px)`,$.w=!1,$.s=!1,$.a=!1,$.d=!1,r>10){let e=r/50*Math.cos(i),t=r/50*Math.sin(i);e>.3&&($.d=!0),e<-.3&&($.a=!0),t>.3&&($.s=!0),t<-.3&&($.w=!0)}}else s.identifier===i&&(eu(s.clientX-o.x,s.clientY-o.y),o={x:s.clientX,y:s.clientY})}},{passive:!1});function s(e){e===r?(r=null,t.style.display=`none`,$.w=!1,$.a=!1,$.s=!1,$.d=!1):e===i&&(i=null)}document.addEventListener(`touchend`,e=>{for(let t=0;t<e.changedTouches.length;t++)s(e.changedTouches[t].identifier)}),document.addEventListener(`touchcancel`,e=>{for(let t=0;t<e.changedTouches.length;t++)s(e.changedTouches[t].identifier)})}var nu=new URLSearchParams(window.location.search),ru=nu.get(`embed`)===`1`,iu=nu.get(`parentOrigin`),au=iu&&/^https?:\/\//.test(iu)?iu:`*`;ru&&document.documentElement.classList.add(`embed-mode`);function ou(e){!ru||window.parent===window||window.parent.postMessage({type:e},au)}var su=new fn;su.fog=new dn(0,150,250);var cu=new na(30,qc(),15,250);cu.position.z=60;var lu=new na(75,qc(),1,5e3);lu.position.set(0,80,120),lu.lookAt(0,0,0);var uu=cu,du=new Wc({antialias:!0});du.setSize(window.innerWidth,window.innerHeight),du.setPixelRatio(Math.min(window.devicePixelRatio,2)),document.body.appendChild(du.domElement),Ql(cu,document.body),tu({showGuide:!ru}),Sl();var{update:fu,resize:pu,getMesh:mu}=ml(su,cu),hu=5+Math.random()*15,gu=[new URL(`/matrix-rain/assets/neo-BKRROx-L.png`,``+import.meta.url).href,new URL(`/matrix-rain/assets/morpheus-B8N9IyYi.png`,``+import.meta.url).href,new URL(`/matrix-rain/assets/smith-D5UTlMPw.png`,``+import.meta.url).href,new URL(`/matrix-rain/assets/smith2-BOWZY_9s.png`,``+import.meta.url).href,new URL(`/matrix-rain/assets/trinity-CtrjEhNL.jpg`,``+import.meta.url).href,new URL(`/matrix-rain/assets/matrix-EYXKv4oQ.jpg`,``+import.meta.url).href],_u=[],vu=performance.now(),yu=new Yr,bu=new Y,xu=[];function Su(){if(xu.length===0){xu=[...gu];for(let e=xu.length-1;e>0;e--){let t=Math.floor(Math.random()*(e+1));[xu[e],xu[t]]=[xu[t],xu[e]]}}return xu.pop()}function Cu(){if(_u.length>=3)return;let e=new K,t=!1,n=0;for(;!t&&n<10;){n++;let r=50+Math.random()*40,i=new K(0,0,-1);i.x+=(Math.random()-.5)*1.5,i.y+=(Math.random()-.5)*1,i.normalize(),i.applyQuaternion(cu.quaternion),e.copy(cu.position).add(i.multiplyScalar(r)),t=!0;for(let n of _u)if(e.distanceTo(n.mesh.position)<60){t=!1;break}}if(!t)return;let{update:r,mesh:i,dispose:a}=vl(su,{imageSrc:Su(),density:2,colorProminence:.95,contrastBoost:!0,brightness:1.5,fadeInDuration:4});i.position.copy(e),i.lookAt(cu.position),su.add(i),_u.push({update:r,mesh:i,dispose:a,spawnTime:performance.now()})}Jc(e=>{cu.aspect=e,cu.updateProjectionMatrix(),lu.aspect=e,lu.updateProjectionMatrix(),du.setSize(window.innerWidth,window.innerHeight),pu(cu)});var wu=performance.now();function Tu(e){requestAnimationFrame(Tu);let t=e-wu;wu=e,Cl(e),$l(t,cu),cu.updateMatrixWorld(),cu.matrixWorldInverse.copy(cu.matrixWorld).invert(),fu(t,cu),e-vu>hu*1e3&&(Cu(),vu=e,hu=5+Math.random()*15),bu.multiplyMatrices(cu.projectionMatrix,cu.matrixWorldInverse),yu.setFromProjectionMatrix(bu);for(let n=_u.length-1;n>=0;n--){let r=_u[n];r.update(t);let i=r.mesh.children[0];i.updateMatrixWorld(),e-r.spawnTime>2e3&&(yu.intersectsObject(i)||(su.remove(r.mesh),r.dispose(),_u.splice(n,1)))}uu===lu&&lu.lookAt(cu.position),Bl(),Pl(`Frame Time`,t.toFixed(2)+` ms`),Pl(`Draw Calls`,du.info.render.calls),Pl(`Triangles`,du.info.render.triangles),performance.memory&&Pl(`Memory (MB)`,(performance.memory.usedJSHeapSize/1048576).toFixed(1)),du.render(su,uu)}Tu(performance.now()),requestAnimationFrame(()=>ou(`MATRIX_RAIN_READY`));var Eu=!1,Du=!1;function Ou(){document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(()=>{})}function ku(){Du=!Du;let e=document.querySelector(`.footer`),t=document.getElementById(`fps-counter`);Du?(e&&(e.style.visibility=`hidden`),Fl(!1),t&&(t.style.visibility=`hidden`)):(e&&(e.style.visibility=`visible`),Fl(Eu),t&&(t.style.visibility=Eu?`visible`:`hidden`))}window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if((t==="`"||t===`~`)&&!Du){Eu=!Eu,Fl(Eu);let e=document.getElementById(`fps-counter`);e&&(e.style.visibility=Eu?`visible`:`hidden`),uu===lu||Eu?Rl(su,cu,mu()):zl(su)}if(t===`g`&&!Du&&(uu=uu===cu?lu:cu,uu===lu||Eu?Rl(su,cu,mu()):zl(su)),t===`f`&&!ru&&Ou(),t===`h`&&ku(),e.key===`Escape`){let e=document.getElementById(`help-modal`);if(e&&!e.classList.contains(`hidden`)){e.classList.add(`hidden`);return}ou(`MATRIX_RAIN_CLOSE`)}});var Au=!1;document.addEventListener(`pointerlockchange`,()=>{let e=document.pointerLockElement!==null;ru&&Au&&!e&&ou(`MATRIX_RAIN_CLOSE`),Au=e});var ju=0,Mu;window.addEventListener(`touchstart`,e=>{if(e.target.closest(`a`)||e.target.closest(`button`)||e.target.closest(`.help-modal-content`))return;let t=new Date().getTime(),n=t-ju;!ru&&n<300&&n>0?(Ou(),clearTimeout(Mu),e.preventDefault()):Mu=setTimeout(()=>{ku()},800),ju=t}),window.addEventListener(`touchend`,()=>clearTimeout(Mu)),window.addEventListener(`touchmove`,()=>clearTimeout(Mu));var Nu=`https://anshulsharma.org/posts/matrix-rain/`,Pu=document.getElementById(`devlog-link-footer`),Fu=document.getElementById(`devlog-link-modal`);Pu&&!Pu.getAttribute(`href`)&&(Pu.href=Nu),Fu&&!Fu.getAttribute(`href`)&&(Fu.href=Nu);var Iu=document.getElementById(`help-modal`),Lu=document.getElementById(`help-toggle`),Ru=document.getElementById(`help-modal-close`);Lu&&Iu&&Lu.addEventListener(`click`,e=>{e.preventDefault(),Iu.classList.toggle(`hidden`)}),Ru&&Iu&&Ru.addEventListener(`click`,()=>{Iu.classList.add(`hidden`)}),Iu&&Iu.addEventListener(`click`,e=>{e.target===Iu&&Iu.classList.add(`hidden`)});