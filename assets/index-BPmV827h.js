...
`);for(let e=1;e<t.length;e++)if(t[e].indexOf(`debug.js`)===-1&&t[e].trim()!==`Error`)return t[e].trim()}return`Unknown source`}function Pl(e,t){if(wl){if(Ol||jl(),t===void 0)El.push({text:e,source:Nl()}),El.length>Dl&&El.shift(),kl=!0;else{let n=Tl.get(e);if(n){if(n.value===t)return;n.value=t}else Tl.set(e,{value:t,source:Nl()});kl=!0}!Al&&kl&&(Al=!0,requestAnimationFrame(Ml))}}function Fl(e){wl=e===void 0?!wl:!!e,Ol&&(Ol.style.visibility=wl?`visible`:`hidden`)}var Il,Ll;function Rl(e,t,n){Il||(Il=new Sa(t),e.add(Il)),!Ll&&n&&(Ll=new Ta(n,16711680),e.add(Ll))}function zl(e){Il&&=(e.remove(Il),Il.dispose(),null),Ll&&=(e.remove(Ll),Ll.dispose(),null)}function Bl(){Il&&Il.update(),Ll&&Ll.update()}var Vl=!1,Hl=0,Ul=0,Wl=!1;function Gl(e){Wl=e}var Kl=new K,$={w:!1,a:!1,s:!1,d:!1,space:!1,shift:!1},ql=30,Jl=.002,Yl;function Xl(e,t){Yl=e;let n=new Rt(0,0,0,`YXZ`);n.setFromQuaternion(e.quaternion),Hl=n.x,Ul=n.y,t.addEventListener(`click`,e=>{if(e.target.closest(`a`)||e.target.closest(`button`)||e.target.closest(`.help-modal-content`))return;let n=document.getElementById(`help-modal`);n&&!n.classList.contains(`hidden`)||Vl||t.requestPointerLock()}),document.addEventListener(`pointerlockchange`,()=>{Vl=document.pointerLockElement===t}),document.addEventListener(`mousemove`,e=>{Vl&&Ql(e.movementX||0,e.movementY||0)}),document.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();t===`w`&&($.w=!0),t===`a`&&($.a=!0),t===`s`&&($.s=!0),t===`d`&&($.d=!0),t===` `&&($.space=!0),t===`shift`&&($.shift=!0)}),document.addEventListener(`keyup`,e=>{let t=e.key.toLowerCase();t===`w`&&($.w=!1),t===`a`&&($.a=!1),t===`s`&&($.s=!1),t===`d`&&($.d=!1),t===` `&&($.space=!1),t===`shift`&&($.shift=!1)})}function Zl(e,t){if(!Vl&&!Wl)return;let n=ql*Math.min(e/1e3,.1),r=Kl;r.set(0,0,0),$.w&&--r.z,$.s&&(r.z+=1),$.a&&--r.x,$.d&&(r.x+=1),$.space&&(r.y+=1),$.shift&&--r.y,r.lengthSq()>0&&(r.normalize(),t.translateX(r.x*n),t.translateY(r.y*n),t.translateZ(r.z*n))}function Ql(e,t){if(!Yl)return;Ul-=e*Jl,Hl-=t*Jl;let n=Math.PI/2-.01;Hl=Math.max(-n,Math.min(n,Hl));let r=new Rt(Hl,Ul,0,`YXZ`);Yl.quaternion.setFromEuler(r)}function $l(){if(!(`ontouchstart`in window||navigator.maxTouchPoints>0))return;Gl(!0);let e=document.createElement(`div`);e.id=`joystick-base`;let t=document.createElement(`div`);t.id=`joystick-stick`,e.appendChild(t),document.body.appendChild(e);let n=document.createElement(`div`);n.id=`mobile-guide`,n.innerHTML=`
  ...
  `,document.body.appendChild(n),setTimeout(()=>{n.style.opacity=`0`,setTimeout(()=>n.remove(),1e3)},4e3);let r=null,i=null,a={x:0,y:0},o={x:0,y:0};document.addEventListener(`touchmove`,n=>{(n.target.tagName===`CANVAS`||n.target===e||n.target===t||n.target.closest(`#mobile-guide`))&&n.preventDefault()},{passive:!1}),document.addEventListener(`touchstart`,n=>{if(!(n.target.closest(`a`)||n.target.closest(`button`)||n.target.closest(`.help-modal-content`)))for(let s=0;s<n.changedTouches.length;s++){let c=n.changedTouches[s],l=c.clientX<window.innerWidth/2;l&&r===null?(r=c.identifier,a={x:c.clientX,y:c.clientY},e.style.display=`block`,e.style.left=`${a.x-50}px`,e.style.top=`${a.y-50}px`,t.style.transform=`translate(0px, 0px)`):!l&&i===null&&(i=c.identifier,o={x:c.clientX,y:c.clientY})}},{passive:!1}),document.addEventListener(`touchmove`,e=>{for(let n=0;n<e.changedTouches.length;n++){let s=e.changedTouches[n];if(s.identifier===r){let e=s.clientX-a.x,n=s.clientY-a.y,r=Math.min(Math.sqrt(e*e+n*n),50),i=Math.atan2(n,e),o=Math.cos(i)*r,c=Math.sin(i)*r;if(t.style.transform=`translate(${o}px, ${c}px)`,$.w=!1,$.s=!1,$.a=!1,$.d=!1,r>10){let e=r/50*Math.cos(i),t=r/50*Math.sin(i);e>.3&&($.d=!0),e<-.3&&($.a=!0),t>.3&&($.s=!0),t<-.3&&($.w=!0)}}else s.identifier===i&&(Ql(s.clientX-o.x,s.clientY-o.y),o={x:s.clientX,y:s.clientY})}},{passive:!1});function s(t){t===r?(r=null,e.style.display=`none`,$.w=!1,$.a=!1,$.s=!1,$.d=!1):t===i&&(i=null)}document.addEventListener(`touchend`,e=>{for(let t=0;t<e.changedTouches.length;t++)s(e.changedTouches[t].identifier)}),document.addEventListener(`touchcancel`,e=>{for(let t=0;t<e.changedTouches.length;t++)s(e.changedTouches[t].identifier)})}var eu=new fn;eu.fog=new dn(0,150,250);var tu=new na(30,qc(),15,250);tu.position.z=60;var nu=new na(75,qc(),1,5e3);nu.position.set(0,80,120),nu.lookAt(0,0,0);var ru=tu,iu=new Wc({antialias:!0});iu.setSize(window.innerWidth,window.innerHeight),iu.setPixelRatio(Math.min(window.devicePixelRatio,2)),document.body.appendChild(iu.domElement),Xl(tu,document.body),$l(),Sl();var{update:au,resize:ou,getMesh:su}=ml(eu,tu),cu=5+Math.random()*15,lu=[new URL(`/matrix-rain/assets/neo-BKRROx-L.png`,``+import.meta.url).href,new URL(`/matrix-rain/assets/morpheus-B8N9IyYi.png`,``+import.meta.url).href,new URL(`/matrix-rain/assets/smith-D5UTlMPw.png`,``+import.meta.url).href,new URL(`/matrix-rain/assets/smith2-BOWZY_9s.png`,``+import.meta.url).href,new URL(`/matrix-rain/assets/trinity-CtrjEhNL.jpg`,``+import.meta.url).href,new URL(`/matrix-rain/assets/matrix-EYXKv4oQ.jpg`,``+import.meta.url).href],uu=[],du=performance.now(),fu=new Yr,pu=new Y,mu=[];function hu(){if(mu.length===0){mu=[...lu];for(let e=mu.length-1;e>0;e--){let t=Math.floor(Math.random()*(e+1));[mu[e],mu[t]]=[mu[t],mu[e]]}}return mu.pop()}function gu(){if(uu.length>=3)return;let e=new K,t=!1,n=0;for(;!t&&n<10;){n++;let r=50+Math.random()*40,i=new K(0,0,-1);i.x+=(Math.random()-.5)*1.5,i.y+=(Math.random()-.5)*1,i.normalize(),i.applyQuaternion(tu.quaternion),e.copy(tu.position).add(i.multiplyScalar(r)),t=!0;for(let n of uu)if(e.distanceTo(n.mesh.position)<60){t=!1;break}}if(!t)return;let{update:r,mesh:i,dispose:a}=vl(eu,{imageSrc:hu(),density:2,colorProminence:.95,contrastBoost:!0,brightness:1.5,fadeInDuration:4});i.position.copy(e),i.lookAt(tu.position),eu.add(i),uu.push({update:r,mesh:i,dispose:a,spawnTime:performance.now()})}Jc(e=>{tu.aspect=e,tu.updateProjectionMatrix(),nu.aspect=e,nu.updateProjectionMatrix(),iu.setSize(window.innerWidth,window.innerHeight),ou(tu)});var _u=performance.now();function vu(e){requestAnimationFrame(vu);let t=e-_u;_u=e,Cl(e),Zl(t,tu),tu.updateMatrixWorld(),tu.matrixWorldInverse.copy(tu.matrixWorld).invert(),au(t,tu),e-du>cu*1e3&&(gu(),du=e,cu=5+Math.random()*15),pu.multiplyMatrices(tu.projectionMatrix,tu.matrixWorldInverse),fu.setFromProjectionMatrix(pu);for(let n=uu.length-1;n>=0;n--){let r=uu[n];r.update(t);let i=r.mesh.children[0];i.updateMatrixWorld(),e-r.spawnTime>2e3&&(fu.intersectsObject(i)||(eu.remove(r.mesh),r.dispose(),uu.splice(n,1)))}ru===nu&&nu.lookAt(tu.position),Bl(),Pl(`Frame Time`,t.toFixed(2)+` ms`),Pl(`Draw Calls`,iu.info.render.calls),Pl(`Triangles`,iu.info.render.triangles),performance.memory&&Pl(`Memory (MB)`,(performance.memory.usedJSHeapSize/1048576).toFixed(1)),iu.render(eu,ru)}vu(performance.now());var yu=!1,bu=!1;function xu(){document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(()=>{})}function Su(){bu=!bu;let e=document.querySelector(`.footer`),t=document.getElementById(`fps-counter`);bu?(e&&(e.style.visibility=`hidden`),Fl(!1),t&&(t.style.visibility=`hidden`)):(e&&(e.style.visibility=`visible`),Fl(yu),t&&(t.style.visibility=yu?`visible`:`hidden`))}window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if((t==="`"||t===`~`)&&!bu){yu=!yu,Fl(yu);let e=document.getElementById(`fps-counter`);e&&(e.style.visibility=yu?`visible`:`hidden`),ru===nu||yu?Rl(eu,tu,su()):zl(eu)}if(t===`g`&&!bu&&(ru=ru===tu?nu:tu,ru===nu||yu?Rl(eu,tu,su()):zl(eu)),t===`f`&&xu(),t===`h`&&Su(),e.key===`Escape`){let e=document.getElementById(`help-modal`);e&&!e.classList.contains(`hidden`)&&e.classList.add(`hidden`)}});var Cu=0,wu;window.addEventListener(`touchstart`,e=>{if(e.target.closest(`a`)||e.target.closest(`button`)||e.target.closest(`.help-modal-content`))return;let t=new Date().getTime(),n=t-Cu;n<300&&n>0?(xu(),clearTimeout(wu),e.preventDefault()):wu=setTimeout(()=>{Su()},800),Cu=t}),window.addEventListener(`touchend`,()=>clearTimeout(wu)),window.addEventListener(`touchmove`,()=>clearTimeout(wu));var Tu=`https://anshulsharma.org/posts/matrix-rain/`,Eu=document.getElementById(`devlog-link-footer`),Du=document.getElementById(`devlog-link-modal`);Eu&&!Eu.getAttribute(`href`)&&(Eu.href=Tu),Du&&!Du.getAttribute(`href`)&&(Du.href=Tu);var Ou=document.getElementById(`help-modal`),ku=document.getElementById(`help-toggle`),Au=document.getElementById(`help-modal-close`);ku&&Ou&&ku.addEventListener(`click`,e=>{e.preventDefault(),Ou.classList.toggle(`hidden`)}),Au&&Ou&&Au.addEventListener(`click`,()=>{Ou.classList.add(`hidden`)}),Ou&&Ou.addEventListener(`click`,e=>{e.target===Ou&&Ou.classList.add(`hidden`)});